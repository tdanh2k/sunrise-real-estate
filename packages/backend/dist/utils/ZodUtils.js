...
export const OptionalBase64 = RequiredString.base64("Không phải chuỗi Base64").optional();
...
export const RequiredEmail = RequiredString.email("Định dạng email không hợp lệ");
